/*
 ...
 Source Server         : iqvia_quartz
 Source Server Type    : MySQL
 Source Server Version : 100513
 Source Host           : sql690.main-hosting.eu:3306
 Source Schema         : u582296798_iqvia_quartz

 Target Server Type    : MySQL
 Target Server Version : 100513
 File Encoding         : 65001

 Date: 31/12/2022 12:01:12
*/
...
-- ----------------------------
-- Table structure for IQVIA_QRTZ_BLOB_TRIGGERS
-- ----------------------------
DROP TABLE IF EXISTS `IQVIA_QRTZ_BLOB_TRIGGERS`;
...
-- ----------------------------
-- Table structure for IQVIA_QRTZ_CALENDARS
-- ----------------------------
DROP TABLE IF EXISTS `IQVIA_QRTZ_CALENDARS`;
...
-- ----------------------------
-- Table structure for IQVIA_QRTZ_CRON_TRIGGERS
-- ----------------------------
DROP TABLE IF EXISTS `IQVIA_QRTZ_CRON_TRIGGERS`;
...
-- ----------------------------
-- Table structure for IQVIA_QRTZ_FIRED_TRIGGERS
-- ----------------------------
DROP TABLE IF EXISTS `IQVIA_QRTZ_FIRED_TRIGGERS`;
...
-- ----------------------------
-- Table structure for IQVIA_QRTZ_JOB_DETAILS
-- ----------------------------
DROP TABLE IF EXISTS `IQVIA_QRTZ_JOB_DETAILS`;
...
-- ----------------------------
-- Table structure for IQVIA_QRTZ_LOCKS
-- ----------------------------
DROP TABLE IF EXISTS `IQVIA_QRTZ_LOCKS`;
...
-- ----------------------------
-- Table structure for IQVIA_QRTZ_PAUSED_TRIGGER_GRPS
-- ----------------------------
DROP TABLE IF EXISTS `IQVIA_QRTZ_PAUSED_TRIGGER_GRPS`;
...
-- ----------------------------
-- Table structure for IQVIA_QRTZ_SCHEDULER_STATE
-- ----------------------------
DROP TABLE IF EXISTS `IQVIA_QRTZ_SCHEDULER_STATE`;
...
-- ----------------------------
-- Table structure for IQVIA_QRTZ_SIMPLE_TRIGGERS
-- ----------------------------
DROP TABLE IF EXISTS `IQVIA_QRTZ_SIMPLE_TRIGGERS`;
...
-- ----------------------------
-- Table structure for IQVIA_QRTZ_SIMPROP_TRIGGERS
-- ----------------------------
DROP TABLE IF EXISTS `IQVIA_QRTZ_SIMPROP_TRIGGERS`;
...
-- ----------------------------
-- Table structure for IQVIA_QRTZ_TRIGGERS
-- ----------------------------
DROP TABLE IF EXISTS `IQVIA_QRTZ_TRIGGERS`;
